...
| Actor-Action Attrib. (Active) | The system code was rewritten to fix bugs. | The senior developer rewrote the system code to fix bugs. | Enforces direct execution trace tracking. Passive syntax structures obscure the executing agent. |
